...
public class CrsList {
	 ...
	 * @param organization_coordsys_id the organization_coordsys_id
	...
	/**
	 * @param srsID the srsId of the CrsListing to identify, never <code>null</code>
	 * @return the organization_coordsys_id of the entry with the passed srs_id,
	...
	/**
	 * @param srsID the srsId of the CrsListing to identify, never <code>null</code>
	 * @return the definition of the entry with the passed srs_id, <code>null</code> if
	 * not available
	 */
	...
	/**
	 * @param srsID the srsId of the CrsListing to identify, never <code>null</code>
	 * @return the description of the entry with the passed srs_id, <code>null</code> if
	 * not available
	 */
