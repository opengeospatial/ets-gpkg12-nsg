...
<ctl:package xmlns:ctl="http://www.occamlab.com/ctl"
  ...
  xmlns:tng="java:org.opengis.cite.gpkg12.nsg.TestNGController">
  ...
  <ctl:function name="tns:run-ets-gpkg12">
    ...
    <ctl:param name="outputDir">The directory in which the test results will be written.</ctl:param>
		...
		<ctl:description>Runs the gpkg12_nsg ${version} test suite.</ctl:description>
    <ctl:code>
   ...
   <ctl:test name="tns:Main">
	  ...
	  <ctl:code>
        ...
        <xsl:variable name="iut-file" select="$form-data//value[@key='doc']/ctl:file-entry/@full-path" />
          ...
          <entry key="ics">Core,Tiles,Features,Attributes,Extension Mechanism,Non-Linear Geometry Types,RTree Spatial Indexes,Tiles Encoding WebP,Metadata,Schema,WKT for Coordinate Reference Systems,Tiled Gridded Coverage Data,NSG</entry>
		    </properties>
		   </xsl:variable>
